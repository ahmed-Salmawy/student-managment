...
@Service
@Slf4j
public class JwtServiceImpl extends AbstractBaseService<TokenDto, UserTokenRepoAdapter> implements JwtService {
    ...
    protected JwtServiceImpl(UserTokenRepoAdapter repoAdapter) {
        super(repoAdapter);
    }
    ...
    public Optional<TokenDto> findByToken(String jwt) {
        return repoAdapter.findByToken(jwt);
